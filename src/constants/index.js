...
const experiences = [
  {
    ...
    icon: epam,
    iconBg: "linear-gradient(115deg, #ffffff, #C0C0C0, #ffffff)",
    date: "Aug 2025 - Mar 2026",
    points: [
      "Developed reusable components using React and TypeScript for a shared component library used by multiple teams.",
      "Implemented unit and integration tests to ensure software quality, reliability, and maintainability.",
      "Contributed to the development of scalable solutions using Next.js and managed components through Bit.cloud.",
      "Collaborated closely with designers, stakeholders, and cross-functional teams to deliver consistent user experiences following Agile methodologies."
    ],
  },
  {
    title: "Front-End Program specialization",
    company_name: "EPAM Systems",
    icon: epam,
    iconBg: "linear-gradient(115deg, #C0C0C0, #ffffff, #C0C0C0)",
    date: "Sep 2024 - Aug 2025",
    points: [
      "Participated in EPAM Systems' Front-End Engineering Program, gaining hands-on experience with JavaScript, TypeScript, React, and modern web development practices.",
      "Collaborated in code reviews, technical workshops, and team-based development activities.",
      "Applied software engineering best practices, including testing, debugging, code quality standards, and maintainable architecture patterns.",
      "Strengthened problem-solving, collaboration, and software development skills in a professional engineering environment."
    ],
  },
  {
    title: "Full stack",
